---
name: lean-ctx
description: Context Runtime for AI Agents with CEP + CCP — 42 MCP tools, 10 read modes, 90+ shell patterns, tree-sitter AST for 18 languages, Cognitive Efficiency Protocol (CEP), cross-session memory (CCP), LITM-aware positioning. Compresses LLM context by up to 99%.
